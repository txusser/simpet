...
class OSEM3DParams(Enum):
    ...
    POISSONLOGLIKELIHOODWITHLINEARMODELFORMEANANDPROJDATA_PARAMETERS = (
        "PoissonLogLikelihoodWithLinearModelForMeanAndProjData Parameters"
    )
    MAXIMUM_ABSOLUTE_SEGMENT_NUMBER_TO_PROCESS = (
    ...
    NUMBER_OF_RAYS_IN_TANGENTIAL_DIRECTION_TO_TRACE_FOR_EACH_BIN = (
    ...
    SAVE_ESTIMATES_AT_SUBITERATION_INTERVALS = (
